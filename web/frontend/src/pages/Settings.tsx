...
const ENV_GROUPS: {
...
}[] = [
  {
    ...
    description: '配置大语言模型接口，影响选股排序质量',
  },
  {
    label: '数据源',
    icon: <Database className="w-4 h-4" />,
    keys: ['SNAPSHOT_SOURCE_PRIORITY', 'TUSHARE_API_URL', 'ALPHASIFT_DATA_DIR'],
    description: '配置行情数据源优先级和本地数据目录',
  },
  {
    label: 'DSA 深度分析',
  ...
  },
  {
    ...
    keys: ['POST_ANALYZERS', 'POST_ANALYSIS_MAX_PICKS'],
    description: '配置选股结果后置分析模块',
  },
  {
    label: '风险评估',
  ...
  },
  {
    ...
    keys: ['DAILY_ENRICH_ENABLED', 'DAILY_ENRICH_MAX_CANDIDATES', 'DAILY_LOOKBACK_DAYS', 'DAILY_SOURCE'],
    description: '每日自动补充实时行情和概念信息',
  },
  {
    label: '回测评估',
